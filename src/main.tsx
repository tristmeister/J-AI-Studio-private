...
function App() {
  ...
  const { upscaleStatus, upscaleInstall, upscaleBusyIds, refreshUpscaleStatus, cancelUpscaleInstall, activateUpscale } = useUpscale({
    prefs,
    confirmAction,
    showToast,
    loadGalleryDelta
